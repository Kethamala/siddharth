...
if ($avsetStatus -eq $null)
{
  ...
  New-AzAvailabilitySet -ResourceGroupName $resourceGroupName -Name $avsetName -Location $rgLocation -PlatformUpdateDomainCount 20 -PlatformFaultDomainCount 2 -sku Aligned
